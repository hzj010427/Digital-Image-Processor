At the beginning of the program, an Image pointer named "image" is declared and initialized to NULL. This pointer will later be used to store the image data after it has been loaded from a file.
